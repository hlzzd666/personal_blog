...
已实现文章、分类与标签、专题、短动态、留言板、关于我、站点设置、媒体管理、访客记录、每日问答、文章统计大屏与 3D 展馆。前台通过版本化 API 读取内容，管理后台使用 Session 与 CSRF 校验；展馆图片支持 OSS，并按开发、生产环境分目录。各模块范围见 `docs/module-discussion.md`。
